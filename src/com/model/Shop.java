...
public class Shop {
	...
	public String getLarge_service_area() {
		return large_service_area;
	}
	public void setLarge_service_area(String large_service_area) {
	...
	public String getMiddle_area() {
		return middle_area;
	}
	public void setMiddle_area(String middle_area) {
	...
	public void setCoupon_qr(String coupon_qr) {
		this.coupon_qr = coupon_qr;
	}
	public String getPhoto_l() {
		return photo_l;
	}
	public void setPhoto_l(String photo_l) {
